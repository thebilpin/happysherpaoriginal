...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4>
                <span class="font-weight-bold mr-2">{{ __('storeDashboard.sortingMenuAndItemForTitle') }}: <a
                        href="{{ route('admin.get.editRestaurant', $restaurant->id) }}"><b>{{ $restaurant->name }}</b></a></span>
            </h4>
            <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
        </div>
        <div class="header-elements d-none py-0 mb-3 mb-md-0">
            <div class="breadcrumb">
                <button type="button" class="btn btn-secondary btn-labeled btn-labeled-left mr-2" data-toggle="modal"
                    data-target="#sortMenuCategoriesModal">
        ...
        <div class="card-body">
            <div class="d-lg-flex justify-content-lg-left">
                <ul class="nav nav-pills flex-column mr-lg-3 wmin-lg-250 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a href="#{{ str_slug($itemCategory->name.'-'.$loop->iteration) }}"
                            class="nav-link @if($loop->first) active @endif each-menu-item" data-toggle="tab">
                            {{ $itemCategory->name }}
                        </a>
                    </li>
                    @endforeach
                ...
                <div class="tab-content" style="width: 100%; padding: 0 25px;">
                    ...
                    <div class="tab-pane fade show @if($loop->first) active @endif"
                        id="{{ str_slug($key.'-'.$loop->iteration) }}">
                                ...
                                <div class="col-md-12" style="border: 1px solid #f2f2f2; padding: 0.5rem;">
                                    <div class="d-flex">
                                        ...
                                        <div class="ml-2">
                                            ...
                                            <p class="mb-0">{{ config('setting.currencyFormat') }}{{ $item->price }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
